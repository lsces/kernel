				...
				{else}
					{if $menu.menu_title}
						{if $gBitSystem->isFeatureActive( 'site_menu_flip_icon' )}
							<a class="head" href="javascript:BitBase.flipIcon('{$key}menu');">{biticon ipackage="icons" iname="list-add"  ipackage="icons"  id="`$key`menuimg" iexplain="folder"}&nbsp;
						{else}
...
{* =========================== User menu =========================== *}
	{if $gBitSystem->isFeatureActive( 'feature_usermenu' ) && $usr_user_menus}
		<li>
			...
			{else}
				{if $gBitSystem->isFeatureActive( 'site_menu_flip_icon' )}
					<a class="head" href="javascript:BitBase.flipIcon('usrmenu');">{biticon ipackage="icons" iname="list-add"  ipackage="icons"  id="usrmenuimg" iexplain="folder"}&nbsp;
				{else}
