	...
	<div class="floatright">
		Web Hosting By <a href="http://rainbowdigitalmedia.co.uk">Rainbow Digital Media <img src="/config/images/rdm-logo32.png" alt="RDM Small Logo" height="32" width="32"></a>
	</div>
