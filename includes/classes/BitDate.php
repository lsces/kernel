...
*/
	...
	// Userland %-format-string strftime() replacement - native PHP's own strftime() was removed
	// in 8.1. No longer touches adodb at all (see kernel/DATETIME.md's 2026-08-31 entry) -
	// translates the format string, then formats via native date()/gmdate(), or a real
	// DateTime+DateTimeZone when $pTimezone is given.
